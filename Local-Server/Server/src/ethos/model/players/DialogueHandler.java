...
//			break;
		...
		case 5998:
			sendNpcChat3("Only <img=4>@red@Donators @bla@can access the Donator Zone.", "Interested in becoming an Pyongyang <img=4>@red@Donator@bla@?", "Go to the bottom of your quest tab and click the <img=19>@yel@Store.", c.talkingNpc, "<img=4>Donation Informative<img=4>");
			c.nextChat = 0;
			break;
		...
		case 55872:
			...
			break;
		case 55873:
			sendNpcChat2("Hello, my name is Banky.", "I was hired by Pyongyang to be a travelling banker!", c.talkingNpc, "Banky The Banker");
			c.nextChat = 0;
			break;
		case 55875:
		...
		case 14011:
			...
			break;
		case 14012:
			sendPlayerChat3("Yeah! I've never seen one before.", "I guess it's one small step for NPC's,", "one giant leap for Pyongyang!");
			c.nextChat = 14013;
			break;
		case 14013:
		...
		case 673:
			sendNpcChat("Glad to see you have joined Pyongyang!", "To start, this is our lovely home area.", "Let me show you around!");
			c.nextChat = 674;
			break;
			
		case 674:
			c.getPA().movePlayer(3080, 3509, 0);
			sendNpcChat("This is where all the shopping happens when", "you first start out! You can buy combat gear,", "foods and pots, or show off your fashion skills!");
			c.nextChat = 675;
			break;
		...
		case 676:
			c.getPA().movePlayer(3093, 3482, 0);
			sendNpcChat("Slayer masters are located here.", "If you would like to do Wilderness Slayer", "run north east of the bank and talk to Krystillia!");
			c.nextChat = 677;
			break;
