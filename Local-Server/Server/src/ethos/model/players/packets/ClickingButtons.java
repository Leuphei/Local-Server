...
//			c.getDH().sendDialogues(12000, -1);
		...
		case 113239:
			...
			c.forcedChat("I've played Pyongyang for a total of : " + time);
			break;
		case 113240:
		...
		case 113250: //yt
			...
			break;
			case 113251: //Discord
				c.getPA().sendFrame126("https://discord.gg/PJBvvGc", 12000);
				//https://www.youtube.com/user/DopeRsps/videos
				break;
			case 113252: //Store
		...
		case 11015:
			if (c.usingLamp) {
				...
				if (c.normalLamp && !c.antiqueLamp) {
					c.usingLamp = false;
					c.getPA().addSkillXP(150000, c.antiqueSelect, true);
...
//			break;
		...
		case 108006: // items kept on death
			...
			c.getPA().sendFrame126("Pyongyang - Items Kept on Death", 17103);
