...
public class Tzkalzuk extends SingleInstancedArea {
	...
	public static final int SPAWN_A = 2267, SPAWN_B = 5344;
	...
	public void spawnNpcs() {
		...
		Server.npcHandler.spawnNpc(player, InfernoWave.JALTOK_JAD, SPAWN_A, SPAWN_B, height, 0, 350, 113, 1000, 480, false, false);
	}
